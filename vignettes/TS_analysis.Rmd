...
write_example_data_to_dir(example_data='MURINE') #MURINE or PBMC
...
my_path_data<-'~/A_Projects/EpiGen/R_Work_Folder/TimeSeriesAnalysis/rmarkdown_method/data/murine/raw_counts_TS'
my_path_sample_dta<-'~/A_Projects/EpiGen/R_Work_Folder/TimeSeriesAnalysis/rmarkdown_method/data/murine/sample_file.csv'
...
PART_l2fc<-4 #log(2)foldChange threshold for PART clustering
...
```{r,echo=F}
if(is.null(GOs_ancestors_clust)==F){
