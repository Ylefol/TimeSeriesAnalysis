...
```{r show_temp_heat_clust ,message=FALSE,warnings=FALSE,echo=FALSE,out.width='100%',fig.height=5, fig.width=15}
heat_list[['temporal']]
```
...
MDS_plots<-wrapper_MDS_and_MDS_clusters(GO_clusters,sem_dta,my_ont_sem_sim,target_dir=NULL,return_plot=TRUE,term_type_gg=TRUE)
```
...
This plot was set as a static plot due to it's large number of hits. An interactive version can also be obtained by setting the 'term_type_gg'
parameter to FALSE
```{r show_MDS_term ,message=FALSE,warnings=FALSE,echo=FALSE,out.width='100%',fig.height=8, fig.width=9}
MDS_plots[['MDS_term']]
```
...
```{r show_dotplot ,echo=FALSE,message=FALSE,warning=FALSE,out.width='100%',fig.height=8, fig.width=9}
gpro_REAC_dotplot
