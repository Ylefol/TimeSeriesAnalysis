...
if (slot(TS_object,'DE_method')=='DESeq2' & 'norm' %in% names(slot(TS_object,'count_matrix'))!=TRUE){
...
samp_dta<-slot(TS_object,'sample_data')
...
sample_dta<-slot(TS_object,'sample_data')
...
**The conditional heatmap**
  `r knitr::include_graphics(paste0(name_result_folder,"/DE_results_conditional/custom_heat_conditional.png"))`

**The temporal heatmap**
  `r knitr::include_graphics(paste0(name_result_folder,"/DE_results_temporal/custom_heat_temporal.png"))`
...
count_matrix_lst<-slot(TS_object,'count_matrix')
gene_matrix_interest<-count_matrix_lst$norm[row.names(count_matrix_lst$norm) %in% genes_of_interest,]
