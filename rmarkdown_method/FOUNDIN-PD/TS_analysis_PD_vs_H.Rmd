---
title: "TimeSeries Analysis – PD vs Heatlhy FOUNDIN-PD"
author: "Yohan Lefol"
...
name_result_folder<-'TS_results_PD_Healthy/'
obj_name<-'timeseries_obj_res.Rdata'

#Path to count data and sample data respectively
#Not needed if using example data
my_path_data<-'~/A_Projects/EpiGen/R_Work_Folder/TimeSeriesAnalysis/data/FOUNDIN-PD/indiv_counts/'
my_path_sample_dta<-'~/A_Projects/EpiGen/R_Work_Folder/TimeSeriesAnalysis/data/FOUNDIN-PD/sample_data.csv'
...
name_control<-'Healthy' #Name of control as seen in the sample file
name_experiment<-'PD' #Name of experiment as seen in the sample file
...
genes_of_interest <- c(
'ENSG00000065057','ENSG00000114026','ENSG00000103152','ENSG00000076248','ENSG00000123415','ENSG00000140398','ENSG00000154328',
'ENSG00000109674','ENSG00000129071','ENSG00000132781','ENSG00000139372','ENSG00000100823','ENSG00000070501','ENSG00000073050',
'ENSG00000143799','ENSG00000137074','ENSG00000042088','ENSG00000039650','ENSG00000105486','ENSG00000005156','ENSG00000168496')


#Custom add - modify list of genes of interest to adjust for transcript (decimal after ENSG code)
#Read a file for the list of genes
test_file<-read.delim('~/A_Projects/EpiGen/R_Work_Folder/TimeSeriesAnalysis/data/FOUNDIN-PD/indiv_counts/RNAB_PPMI18567_4073_da0_v2.counts',header=F)
ENSG_transcripts<-test_file$V1
rm(test_file)
ENSG_transcripts<-ENSG_transcripts[startsWith(ENSG_transcripts,'ENSG')]
rem_decimal<-unlist(strsplit(ENSG_transcripts,'\\.'))[c(T,F)]
equivalence_df<-data.frame(transcript=ENSG_transcripts,gene=rem_decimal)
transcript_of_interest<-equivalence_df[equivalence_df$gene %in% genes_of_interest,]
genes_of_interest<-transcript_of_interest$transcript
...
TS_object<-run_gprofiler_PART_clusters(TS_object,ENSG_transcript_adjust = T) #Run the gprofiler analysis
