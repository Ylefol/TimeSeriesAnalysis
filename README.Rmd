...
Version 1.1.0
* GSEA of differential gene expression analysis (DESeq2 only)
...
* GSEA support via ClusterProfiler was added for differential gene expression results. You can find this small script in the 'extra_scripts' folder.
* Support added for transcript counts via tximport. This may be useful if quantification was done for transccripts instead of genes (salmon, kallisto etc...).
