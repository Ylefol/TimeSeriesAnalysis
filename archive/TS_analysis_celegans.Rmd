...
TS_pca<-plot_PCA_TS(TS_object,DE_type='all',show_names = FALSE)
...
gpro_BP_dotplot<-GO_dotplot_wrapper(TS_object,file_loc=NULL,target_ontology=select_ontology,top_n=target_top,return_plot = TRUE)

```
Illustrated below is the dotplot for the Biological Process results
```{r show_dotplot ,echo=FALSE,message=FALSE,warning=FALSE,out.width='100%',fig.height=16, fig.width=9}
gpro_BP_dotplot
